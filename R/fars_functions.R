...
#'
#' \code{fars_read} checks the existence of the file (based on the filename
...
#' Make File Name
#'
#' \code{make_filename} is a simple function to create file names for the data files. Fatality accident
